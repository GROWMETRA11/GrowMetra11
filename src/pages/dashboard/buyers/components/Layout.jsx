...
const Layout = ({children}) => {
  ...
  const dashBoardLink = [
    ...
    },
    {
      ...
      links: "/dashboard/buyers/products",
    },
    {
      title: "Add Product",
      activeIcon: <OrdersIcon color="#FFFFFF" />,
      inActiveIcon: <OrdersIcon color="#545454" />,
      links: "/dashboard/buyers/add-Product",
    },
    {
      title: "Inventory",
      activeIcon: <WalletIcon color="#FFFFFF" />,
      inActiveIcon: <WalletIcon color="#545454" />,
      links: "/dashboard/buyers/inventory",
    },
    {
      title: "Orders",
      activeIcon: <Cart color="#FFFFFF" />,
      inActiveIcon: <Cart color="#545454" />,
      links: "/dashboard/buyers/orders",
    },
    {
      title: "Deliveries",
      activeIcon: <Cart color="#FFFFFF" />,
      inActiveIcon: <Cart color="#545454" />,
      links: "/dashboard/buyers/deliveries",
    },
    {
      title: "Wallet",
      activeIcon: <Cart color="#FFFFFF" />,
      inActiveIcon: <Cart color="#545454" />,
      links: "/dashboard/buyers/wallet",
    },
    {
      title: "Farm Profile",
      activeIcon: <Cart color="#FFFFFF" />,
      inActiveIcon: <Cart color="#545454" />,
      links: "/dashboard/buyers/farm-profile",
    },
    {
      title: "Verification Center",
      activeIcon: <Cart color="#FFFFFF" />,
      inActiveIcon: <Cart color="#545454" />,
      links: "/dashboard/buyers/verification-center",
    },
    {
      title: "Analytics",
      activeIcon: <Cart color="#FFFFFF" />,
      inActiveIcon: <Cart color="#545454" />,
      links: "/dashboard/buyers/analytics",
    },
    {
      title: "Settings",
      activeIcon: <Cart color="#FFFFFF" />,
      inActiveIcon: <Cart color="#545454" />,
      links: "/dashboard/buyers/settings",
    },
  ];
